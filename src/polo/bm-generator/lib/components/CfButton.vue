    ...
    routerLink() {
      ...
      if (this.btn.options.name) {
        ...
        if (this.btn.options.queryParams) {
          link.query = Helper.makeParams(
            this.btn.options.queryParams,
            this.data
          );
        }
        if (this.btn.options.paramsParams) {
          link.params = Helper.makeParams(
            this.btn.options.paramsParams,
            this.data
          );
        }
      } else {
