...
export default {
  ...
  mounted() {
    ...
    const oldSave = this.editor.theme.tooltip.save.bind(this.editor.theme.tooltip)
    const instance = this
  ...
  methods: {
    ...
    appendImageIcon() {
      ...
      polyline.setAttribute('points', '5 12 5 11 7 9 8 10 11 7 13 9 13 12 5 12')
      polyline.classList.add('ql-even')
      polyline.classList.add('ql-fill')
      svg.appendChild(polyline)
      const parentNode = document.querySelector('.ql-toolbar .ql-image .ql-picker-label')
