...
// GET 主体资质类型
export const getNameAndValue = (type) =>
  request.get('/console/mdsp/admin/sponsor/getNameAndValue', { params: { type } });

// GET 用户详情
export const getUserProfile = (agentSponsorId) =>
  request.get('/console/mdsp/sponsor/get', { params: { agent_sponsor_id: agentSponsorId } });

// GET 广告主详情
export const getSponsorDetail = (sponsorId) =>
  request.get('/console/mdsp/admin/sponsor/detail', { params: { sponsorId } });
